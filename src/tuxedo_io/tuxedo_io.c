...
static int tdp_min_x6fr57tk[] = { 0x0a, 0x14, 0x19 }; //10, 20 ,25   default 10, 10, 10,
static int tdp_max_x6fr57tk[] = { 0x3C, 0x64, 0x64 }; //60, 100, 100  default 145, 145, 167
...
static void uw_id_tdp(void)
{
	if (uw_feats->model == UW_MODEL_PH4TUX) {
		...
		tdp_min_defs = tdp_min_x6fr57tk;
		tdp_max_defs = tdp_max_x6fr57tk;	
